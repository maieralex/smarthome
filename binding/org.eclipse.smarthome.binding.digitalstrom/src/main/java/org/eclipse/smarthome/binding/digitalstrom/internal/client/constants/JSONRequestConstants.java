...
public interface JSONRequestConstants {
	...
	public final static String	JSON_SYSTEM_GET_DSID					= JSON_SYSTEM_PREFIX+GET_DSID_TO_STRING+JSON_TOKEN_AT_LAST_PREFIX;
	
	//public final static String	JSON_SYSTEM_ENABLE_APPLICATION_TOKEN	= JSON_SYSTEM_PREFIX+ENABLE_APPLICATION_TOKEN+JSON_TOKEN_AT_LAST_PREFIX;
