...
public class CircuitScheduler {
    ...
    public CircuitScheduler(SensorJob sensorJob) {
        ...
        System.out.println("create circuitScheduler: " + this.getMeterDSID() + " and add sensorJob: "
    ...
    public void addSensorJob(SensorJob sensorJob) {
        synchronized (sensorJobQueue) {
            if (!this.sensorJobQueue.contains(sensorJob)) {
                ...
                System.out.println(
                        "add sensorJob: " + sensorJob.toString() + "to circuitScheduler: " + this.getMeterDSID());
            } else if (checkSensorJobPrio(sensorJob)) {
                System.out.println("add sensorJob: " + sensorJob.toString()
                        + "with higher priority to circuitScheduler: " + this.getMeterDSID());
            } else {
                System.out.println(
                        "sensorJob: " + sensorJob.getDsid().toString() + " allready exist with a higher priority");
            }
        }
    }
